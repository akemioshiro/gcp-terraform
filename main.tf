provider "google" {
  project = "akemioshiro-devops-iac"
  region  = "us-central1"
  zone    = "us-central1-c"
...
resource "google_project" "akemioshirosa-salesforce-dev" {
  name       = "SalesForce-Dev"
  project_id = "akemioshirosa2-salesforce-dev"
...
# resource "google_project" "akemioshirosa-salesforce-prod" {
#   name       = "SalesForce-Prod"
#   project_id = "akemioshirosa-salesforce-prod"
